...
if (! isset($_POST['BalancePeriodEnd']) or isset($_POST['SelectADifferentPeriod'])){
	...
	echo '<p><table class="enclosed"><tr><td>'._('Select the balance date').":</td><td><select Name='BalancePeriodEnd'>";
	...
	echo '<div class=invoice><table class="enclosed"><tr><th colspan=6><div class="centre"><font size=4 color=blue><b>' .
