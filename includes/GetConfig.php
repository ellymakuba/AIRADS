...
/* $Id: GetConfig.php 3516 2010-06-24 08:31:39Z tim_schofield $*/
...
/* Also reads all the company data set up in the company record and returns an array */
	...
	if (DB_num_rows($ReadCoyResult)==0) {
      		echo '<BR><B>';
		prnMsg( _('The school record has not yet been set up') . '</B><BR>' . _('From the system setup tab select school maintenance to enter the school information and system preferences'),'error',_('CRITICAL PROBLEM'));
		exit;
	} else {
