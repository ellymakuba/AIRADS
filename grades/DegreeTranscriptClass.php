...
class bus_report {
	...
	function bus_report($student,$mp_array, $db) {
		$this->subject = $this->get_subject($db);

		$this->scheduled_subjects = $this->get_scheduled_subjects($student,$mp_array,$db);
	}
	...
	function get_scheduled_subjects($student,$mp_array,$db) {
...
function total_marks($student_id,$calendar_id, $subject_id,$db) {
