...
<?php 
if (isset($id)) {
$sql = "SELECT SUM(unitprice) as totalInvoiceAmount,sum(discount) as disc FROM invoice_items WHERE invoice_id ='".$id."'";
$result = DB_query($sql,$db);
$row = DB_fetch_array($result);
$_POST['total_invoice'] = $row['totalInvoiceAmount']-$row['disc'];			
...
if (isset($_POST['payment'])) {
	...
	ORDER BY invoice_items.priority,invoice_items.product_id";
	$result=DB_query($sql, $db);
